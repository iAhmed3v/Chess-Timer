...
public class FifteenMinActivity extends AppCompatActivity {
    ...
    int counterOne = 900 , counterTwo = 900;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerOneTextCounter.setText("15:00");
        ...
        playerTwoTextCounter.setText("15:00");
        ...
        restartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder = new AlertDialog.Builder(FifteenMinActivity.this);

                inflater = LayoutInflater.from(FifteenMinActivity.this);
                ...
                yesButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(FifteenMinActivity.this, MainActivity.class);
