...
public class TwentyMinActivity extends AppCompatActivity {
    ...
    int counterOne = 1200 , counterTwo = 1200;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerOneTextCounter.setText("20:00");
        ...
        playerTwoTextCounter.setText("20:00");
        ...
        restartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder = new AlertDialog.Builder(TwentyMinActivity.this);

                inflater = LayoutInflater.from(TwentyMinActivity.this);
                ...
                yesButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(TwentyMinActivity.this, MainActivity.class);
