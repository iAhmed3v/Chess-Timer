...
public class TenMinActivity extends AppCompatActivity {
    ...
    int counterOne = 600 , counterTwo = 600;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerOneTextCounter.setText("10:00");
        ...
        playerTwoTextCounter.setText("10:00");
        ...
        restartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder = new AlertDialog.Builder(TenMinActivity.this);

                inflater = LayoutInflater.from(TenMinActivity.this);
                ...
                yesButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(TenMinActivity.this, MainActivity.class);
