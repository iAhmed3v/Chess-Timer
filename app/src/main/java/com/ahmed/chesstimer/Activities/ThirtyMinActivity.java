...
public class ThirtyMinActivity extends AppCompatActivity {
    ...
    int counterOne = 1800 , counterTwo = 1800;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerOneTextCounter.setText("30:00");
        ...
        playerTwoTextCounter.setText("30:00");
        ...
        restartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder = new AlertDialog.Builder(ThirtyMinActivity.this);

                inflater = LayoutInflater.from(ThirtyMinActivity.this);
                ...
                yesButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(ThirtyMinActivity.this, MainActivity.class);
